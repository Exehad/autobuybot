...
const walmartLink =
  "https://www.walmart.com/ip/Restored-Nintendo-Switch-Lite-Game-Console-with-Retrofam-Carry-Case-International-Version-Random-Refurbished/19616156145?conditionGroupCode=2&classType=VARIANT";
...
const zipCode = "test";
const address = "test";
const creditCardNumber = "test";
const expirationMonth = "test";
const expirationYear = "test";
const cvv = "test";
